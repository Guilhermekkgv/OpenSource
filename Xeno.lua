...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            local darkBlueColor = Color3.fromRGB(0, 60, 170)
            ...
            Btn.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseButton1 then
                    TweenService:Create(BtnFrame, tweenInfo, {BackgroundColor3 = blueColor}):Play()
                end
            end)
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob and thisText then
                    ...
                    if currentState then
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = blueColor}):Play()
                        ...
                        TweenService:Create(thisText, tween, {TextColor3 = blueColor}):Play()
                    else
                ...
                if IsOpen then
                    for i, opt in pairs(Options) do
                        local OptBtn = Linux.Instance("TextButton", {
                            ...
                            Font = Enum.Font.GothamSemibold,
                            Text = tostring(opt),
                            TextColor3 = opt == SelectedValue and blueColor or Color3.fromRGB(200, 200, 210),
                            TextSize = 14,
                            ZIndex = 3,
                            AutoButtonColor = false,
                            LayoutOrder = i
