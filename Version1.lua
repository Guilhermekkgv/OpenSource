    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            Btn.MouseEnter:Connect(function()
                TweenService:Create(BtnFrame, tweenInfo, {BackgroundColor3 = Color3.fromRGB(35, 35, 40, 128)}):Play()
        ...
        function TabElements.Toggle(config)
            ...
            Linux.Instance("UIGradient", {
                ...
                Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(130, 120, 180)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(100, 90, 150))
                }),
                Enabled = false,
                Rotation = 90
            })
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob then
                    ...
                    if currentState then
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = accentColor}):Play()
                ...
                if IsOpen then
                    for i, opt in pairs(Options) do
                        local OptBtn = Linux.Instance("TextButton", {
                            ...
                            Font = Enum.Font.GothamSemibold,
                            Text = tostring(opt),
                            TextColor3 = opt == SelectedValue and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(160, 160, 168),
                            TextSize = 14,
                            ZIndex = 3,
                            AutoButtonColor = false,
                            LayoutOrder = i
                                ...
                                for _, btn in pairs(OptionsHolder:GetChildren()) do
                                    if btn:IsA("TextButton") then
                                        if btn.Text == tostring(opt) then
                                            ...
                                            btn.TextColor3 = Color3.fromRGB(160, 160, 168)
